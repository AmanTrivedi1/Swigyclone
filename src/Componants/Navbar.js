...
<div className="flex font-poppins sticky top-0 z-50 bg-[#fff]   mb-5 shadow-lg pl-10 pr-10 justify-between items-center">
    ...
    <div className="cursor-pointer" >
      <ul className=" flex gap-12 ">
        <li className="bg-[#52C47B] hover:shadow-md text-[#fff] pr-[10px] pt-[4px] pb-[5px] pl-[10px]">Login</li>
        <li className="bg-[#52C47B] hover:shadow-md text-[#fff] pr-[10px] pt-[4px] pb-[5px] pl-[10px]">SignUp</li>
      </ul>
    </div>
  </div>
  </>
